...
string in2prefix(string infix)
{
    ...
    // cetak dengan looping selama akhir string ada isinya
    while (infix[i] != '\0')
    {
        ...
        else
        {
            ...
            // jika prioritas operator kurang dari atau dengan operator yang
            // di stack, pop operator di posisi top dan tambahkan postfx
